            ...
            <div class="card employee-card">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">GitHub: <a href="https://github.com/${engineer.getGithub()}" target="_blank" rel="noopener noreferrer" class="text-decoration-none">${engineer.getGithub()}</a></li>
                    </ul>
                </div>
            </div>
        </div>
